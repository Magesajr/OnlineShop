...
from util import (generate_token,order_track,
payment_form,subimit_order,payment_email)
from datetime import datetime
from flask_wtf import FlaskForm
from wtforms import (BooleanField,EmailField,FloatField,SelectField,
StringField,SubmitField,TelField,PasswordField)
from wtforms.validators import DataRequired,Length,Email,ValidationError,Optional


app=Flask(__name__,template_folder='templetes')
app.config['SECRET_KEY']='you nvr guees'
app.config['consumer_secret']='q27RChYs5UkypdcNYKzuUw460Dg='
app.config['consumer_key']='ngW+UEcnDhltUc5fxPfrCD987xMh3Lx8'
